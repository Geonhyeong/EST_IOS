...
final class AudioManager {
    ...
    fileprivate var playerList = [AVAudioPlayer]()
    ...
    init(_ micToggler:Observable<MicState>, speakerToggle:Observable<SpeakerType>, TalkBtn:UIButton, StopBtn:UIButton)throws
    {
...
//        print ("time = \(timeE)")
    ...
    func settingVolume(Volume : Float) {
